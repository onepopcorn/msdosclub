...
// const defaultImages = {
//     thumbnail: {
//         file: 'default_thumbnail.jpg',
//         height: 15,
//         width: 15,
//         mime_type: "image/jpeg",
//         source_url: `${process.env.PUBLIC_URL}/default_thumbnail.jpg`,
//     },
//     medium: {
//         file: 'default_medium.jpg',
//         height: 221,
//         width: 245,
//         mime_type: "image/jpeg",
//         source_url: `${process.env.PUBLIC_URL}/default_medium.jpg`,
//     },
//     full: {
//         file: 'default_full.jpg',
//         height: 663,
//         width: 737,
//         mime_type: "image/jpeg",
//         source_url: `${process.env.PUBLIC_URL}/default_full.jpg`,
//     },
// }
...
function isValidNode(node: HTMLElement, title: string): boolean {
    ...
    return !node.querySelector('.powerpress_player')
...
export const getPostImages = (embed:any): PostImageData => {
    ...
    let { thumbnail, medium, full } : {thumbnail: PostImage, medium: PostImage, full: PostImage} = images.media_details.sizes
